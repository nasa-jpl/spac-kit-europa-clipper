...
ancillary_data_pkt = ccsdspy.VariableLength(
    ancillary_data_pkts,
    apid=1392,
    name="ancillary_data",
    description="Ancillary data packet structure, "
                "see specification in MISE Flight Software Specification 7489-9100, "
                "Table 55. Ancillary Data"
)
